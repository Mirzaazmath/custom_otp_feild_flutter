...
class OTPField extends StatefulWidget {
  ...
  const OTPField({super.key,this.length=4,this.spaceBetween=10,required this.otpController});
...
// To Listen Keyboard Events
        ...
        child: Center(
          child: ListView.builder(
            ...
            itemCount:widget.length,
              ...
              height: 40,
              width: 40,
              margin: EdgeInsets.only(right:index==widget.length-1?0: widget.spaceBetween),
              child: TextField(
                maxLength: 1,
    ...
    void changeFocusToPreviousNodeWhenTapBackspace() async {
      ...
      if(_focusNodes[index].hasFocus&&_textControllers[index].text.isNotEmpty){
